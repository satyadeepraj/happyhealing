...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-[#999999] font-sans">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            <h3 className="font-bold text-white">Buy Now</h3>
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            <h3 className="font-bold text-white">Get The Latest Deals</h3>
            <p>And Stay Updated With Cremica’s Innovations</p>
            <form className="mt-4 flex gap-4">
              <input
                type="email"
                className="px-2 py-2  bg-transparent border rounded-lg"
            ...
            <h3 className="font-bold text-white mt-7">Get The Latest Deals</h3>
      ...
      <div className="bg-red-600 text-center text-white py-4 ">
        <p>
          Copyright © 2023 Cremica Food Industries Limited. All Rights Reserved.
        </p>
      </div>
    </footer>
  );

...
export function Belowheader() {
  return (
    <div className="">
      <main className="py-20">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <Card className="text-center py-4">
            ...
            <CardTitle className="py-4 font-bold">
              Upload Prescription
            </CardTitle>
      ...
      <div className="fixed bottom-8 mobile:right-4 right-8 flex flex-col space-y-4">
        <Button
          variant="outline"
          className="rounded-full p-3 bg-white shadow-lg"
        >
